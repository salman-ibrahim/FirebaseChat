...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void clickRegister(View view) {
        ...
        if(validate(username, password, repeatPassword)){
            ...
            if(username.isEmpty() && password != repeatPassword) {
                Toast.makeText(this, "Invalid Email and Passwords does not match", Toast.LENGTH_SHORT).show();
            }
            else if(username.isEmpty() && password == repeatPassword) {
