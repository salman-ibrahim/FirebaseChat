...
import com.salmanibrahim.firebasechat.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    /**
     * Initialization of the components required for login management
     */
    private void initFirebase() {
        //Firebase authentication is required to log in and register
        ...
        //Open a waiting dialog when login
    ...
    class AuthUtils {
                    ...
                    .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                initNewUserInfo();
                                Toast.makeText(LoginActivity.this, "Successfully Registered! Logging in.", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(LoginActivity.this, MainActivity.class));
                                LoginActivity.this.finish();
                            }
                        }
        ...
        /**
         * Save user info for the currently logged-in user
         */
        void saveUserInfo() {
        ...
        /**
         * This Part will handle new user login info
         */
