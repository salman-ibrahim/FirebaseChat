package com.salmanibrahim.firebasechat;
...
import com.salmanibrahim.firebasechat.ui.FriendsFragment;
import com.salmanibrahim.firebasechat.ui.GroupFragment;
import com.salmanibrahim.firebasechat.ui.LoginActivity;
import com.salmanibrahim.firebasechat.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initFirebase() {
        //required to log in and register
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "FirebaseChat version 1.0.1", Toast.LENGTH_LONG).show();
            return true;
        }
